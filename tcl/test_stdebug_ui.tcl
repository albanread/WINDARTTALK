...
after 800
puts "  snap -> [ui snap e:/windart-talk/build/ui_stdebug_stack.png]"
puts "  usdbsel 0 (top frame) -> [ui usdbsel 0]"
after 400
puts "  snap -> [ui snap e:/windart-talk/build/ui_stdebug_frame.png]"
puts "  usdebug ok case -> [ui usdebug {6 * 7}]"
after 500
puts "  snap -> [ui snap e:/windart-talk/build/ui_stdebug_ok.png]"
exit 0
